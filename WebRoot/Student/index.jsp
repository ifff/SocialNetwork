...
<body>
	...
	<div id="Header">
		<ul id="1" class="MenuBar">
			...
			<span class="sep">|</span>
			<li><a href="EvalCourse/index.jsp" style="padding: 5px 30px 0;">课程评估</a>
			</li>
			<span class="sep">|</span>
	...
	<div id="Function">
		<ul>
			<li id="studentinfo"><a href="StudentInfo/index.jsp"><img
					src="../Images/personal.png" /><br />个人信息</a></li>
			<li id="electiveinfo"><a href="Elective/index.jsp"><img
					src="../Images/elective.png" /><br />选课安排</a></li>
			<li id="achievementinfo"><a href="AchievementInfo/index.jsp"><img
					src="../Images/achievement.png" /><br />成绩查看</a></li>
			<li id="evalcourse"><a href="EvalCourse/index.jsp"><img
					src="../Images/stueval.png" /><br />课程评估</a></li>
			<li id="declaration"><a href="Declaration/index.jsp"><img
					src="../Images/elective_public.png" /><br />申报系统</a></li>
		</ul>
	</div>
	<%
	if(account != null){
