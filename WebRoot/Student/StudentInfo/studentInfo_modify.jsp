...
<body>
	...
	<div id="Header">
		<ul id="1" class="MenuBar">
			...
			<span class="sep">|</span>
			<li class="current"><a href="../StudentInfo/index.jsp"
	...
	<form id="form1" method="post" action="student?action=modifyInfo">
		<table table width="65%" class="TABLE_BODY" bordercolor="#777777"
			border="1" style="border-color: #777777; border-collapse: collapse"
			align="center">
			<tr class="TABLE_TH">
			...
			<tr class="TABLE_TR_01">
				...
				<td><%=nation %></td>
				<td>英文名字</td>
				<td><label for="name_en"></label> <input type="text"
					name="name_en" id="name_en" value="<%=name_en %>"
					style="height: auto; width: auto" /></td>
			</tr>
			<tr class="TABLE_TR_02">
				<td>毕业学校</td>
				<td><label for="gradu_sch"></label> <input type="text"
					name="gradu_sch" id="gradu_sch" value="<%=gradu_sch %>"
					style="height: auto; width: auto" /></td>
				<td>邮箱</td>
				<td><label for="email"></label> <input name="email" type="text"
					id="email" value="<%=email %>" style="height: auto; width: auto" /></td>
				<td>电话号码</td>
				<td><label for="telephone"></label> <input type="text"
					name="telephone" id="telephone" value="<%=telephone %>"
					style="height: auto; width: auto" /></td>
			</tr>
			<tr class="TABLE_TR_01">
				<td>家庭邮编</td>
				<td><label for="pos_code"></label> <input type="text"
					name="pos_code" id="pos_code" value="<%=pos_code%>"
					style="height: auto; width: auto" /></td>
				<td>家庭住址</td>
				<td colspan="3"><label for="home_addr"></label> <input
					type="text" name="home_addr" id="home_addr" value="<%=home_addr%>"
					style="height: auto; width: 400px" /></td>
			</tr>
			<tr class="TABLE_TR_02">
				<td colspan="6" align="center"><input type="submit"
					name="submit" id="submit" value="保存" /></td>
			</tr>
		</table>
