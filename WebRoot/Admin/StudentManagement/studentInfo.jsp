 ...
 %>
	<div id="Header">
		<ul id="1" class="MenuBar">
			...
			<span class="sep">|</span>
			<li class="current"><a href="../StudentManagement/index.jsp"
	...
	<form id="form1" name="form1" method="post"
		action="admin?action=queryStudentInfo">
		<table width="592" height="43" align='center'>
			<tr>
				<td width="68" height="16">院系名称：</td>
				<td width="217"><label for="college_name"></label> <select
					name="college_name" id="college_name"
      ...
      %>
				...
				<td width="70">入学年份：</td>
				<td width="144"><label for="entr_time"></label> <select
					name="entr_time" id="entr_time" style="height: auto; width: 100px">
						<%
    	 ...
    	 %>
				...
				<td width="69"><input type="submit" name="submit" id="submit"
					value="提交" "/></td>
			</tr>
		</table>
		</br>
