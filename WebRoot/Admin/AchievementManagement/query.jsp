...
<body>
	...
	<div id="Header">
		<ul id="1" class="MenuBar">
			...
			<span class="sep">|</span>
			<li class="current"><a href="../AchievementManagement/index.jsp"
	...
	<div align="center">
		<form id="form1" name="form1" method="post"
			action="admin?action=getgrades">
			<p>
				<label for="keywords">查找关键词</label> <select name="keywords"
					id="keywords">
					<option value="0">学号</option>
					<option value="1">姓名</option>
					<option value="2">年级</option>
					<option value="3">课程号</option>
				</select> <label for="content"></label> <input type="text" name="content"
					id="content" value="<%%>" />
			</p>
			<p>
				<label for="college">院系</label> <select name="college" id="college">
