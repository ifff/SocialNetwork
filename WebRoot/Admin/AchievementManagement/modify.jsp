...
<body>
	...
	<div align="center">
		<form id="form1" name="form1" method="post"
			action="acdemicDean?action=modify">
			<p>
				<label for="stu_num">学号</label> <input type="text" name="stu_num"
					id="stu_num" value="<%=stu_num%>" />
			</p>
			<p>
				<label for="course_id">课程号</label> <input type="text"
					name="course_id" id="course_id" value="<%=course_id%>" />
			</p>
			<p>
