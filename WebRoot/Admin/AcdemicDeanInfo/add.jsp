	...
	<form id="form1" method="post" action="admin?action=addAcdemicDean">
		<table width='35%' class='TABLE_BODY' bordercolor='777777' border='1'
			...
			<tr class='TABLE_TR_01'>
				...
				<td><label for="user"></label> <input type="text" name="user"
					id="user" /></td>
			</tr>
			<tr class='TABLE_TR_02'>
				<td align="center">密码：</td>
				<td><label for="pwd"></label> <input type="password" name="pwd"
					id="pwd" /></td>
			</tr>
			<tr class='TABLE_TR_01'>
				<td align="center">院系名称：</td>
				<td><label for="collegename"></label> <input type="text"
					name="collegename" id="collegename" /></td>
			</tr>
			<tr class='TABLE_TR_02'>
				<td colspan="2" align="center"><input type="submit"
					name="submit" id="submit" value="提交" onclick="return check(form1)" />&nbsp;&nbsp;&nbsp;
