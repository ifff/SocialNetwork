...
<body>
	...
	<div id="Header">
		<ul id="1" class="MenuBar">
			...
			<span class="sep">|</span>
			<li class="current"><a href="../AcdemicDeanInfo/index.jsp"
	...
	<form id="form1" method="post" action="admin?action=modifyPwd">
		<table width='40%' class='TABLE_BODY' bordercolor='777777' border='1'
			...
			<tr class='TABLE_TR_01'>
				...
				<td width="325"><label for="oldPwd"></label> <input
					type="password" name="oldPwd" id="oldPwd" /></td>
			</tr>
			<tr class='TABLE_TR_02'>
				<td align="center" class="tablebody">新密码：</td>
				<td><label for="newPwd"></label> <input type="password"
					name="newPwd" id="newPwd" /></td>
			</tr>
			<tr class='TABLE_TR_01'>
				<td align="center" class="tablebody">确认新密码：</td>
				<td><label for="cnewPwd"></label> <input type="password"
					name="cnewPwd" id="cnewPwd" /></td>
			</tr>
			<tr class='TABLE_TR_02'>
				<td colspan="2" align="center" class="tablebody"><input
