...
%>
		<form id="form1" name="form1" method="post"
			action="acdemicDean?action=addgrades">
			<table width="60%" border="1" cellpadding="0" cellspacing="1"
				align="center" bordercolor="#999999" bordercolordark="#FFFFFF"
				...
				<tr>
					<td><input type="text" name="stu_num" id="stu_num"
						value="<%=stu_num %>"
						style="border-style: none; height: 30px; width: 275px" /></td>
				...
				<tr>
					<td colspan="4" style="padding: 5px;"><input type="submit"
						name="submit" id="submit" value="添加" onclick="return check(form1)" />
					</td>
				</tr>
				<%
	//}
	if(mode != 0) {
		%>
				<tr>
					<td colspan="4" style="padding: 5px;"><font color=red>
							<%=err %>
					</font></td>
				</tr>
				<%
