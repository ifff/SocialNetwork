...
<body>
	...
	<div id="Header">
		<ul id="1" class="MenuBar">
			...
			<span class="sep">|</span>
			<li class="current"><a href="../Elective/index.jsp"
	...
	<form id="form1" method="post" action="acdemicDean?action=insertCourse">
		...
		<table width='65%' class='TABLE_BODY' bordercolor='777777' border='1'
       ...
       %>
			...
			<tr class='TABLE_TR_02'>
				<td height="36" colspan="6" align="center"><input type="submit"
