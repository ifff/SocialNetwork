	...
	<form id="form1" method="post" action="acdemicDean?action=establish">
		<table width='75%' class='TABLE_BODY' bordercolor='777777' border='1'
			...
			<tr class='TABLE_TR_01'>
				<td><label for="proj_name"></label> <input type="text"
					name="proj_name" id="proj_name" /></td>
				<td><label for="teacher_name"></label> <input type="text"
					name="teacher_name" id="teacher_name" /></td>
				<td><label for="brief_intro"></label> <textarea
						name="brief_intro" id="brief_intro" cols="45" rows="5"></textarea></td>
				<td><input type="checkbox" name="selected" id="selected" /> <label
					for="selected"></label></td>
			</tr>
			<tr class='TABLE_TR_02'>
				<td td colspan='6' align='center'><input type="submit"
					name="save" id="save" value="提交" /></td>
			</tr>
		</table>
