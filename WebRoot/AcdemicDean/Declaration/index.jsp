...
<body>
	...
	<div id="Function">
		<ul>
			<li><a href="../Declaration/declaration.jsp"><img
					src="../../Images/elective_gym.png" /><br />申报项目修改</a></li>
			<li><a href="../Declaration/establish.jsp"><img
					src="../../Images/elective_gym.png" /><br />创建项目</a></li>
		</ul>
	</div>
